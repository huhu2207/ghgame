...
namespace MinGH.EngineExtensions
{
    ...
    /// </summary>
    public class LaneSeparators : GameObject3D
    {
        /// <summary>
        ...
        public LaneSeparators(int laneSize, int laneBorderSize, Effect effectToUse, Texture2D texture, GraphicsDevice graphics)
        ...
        public void initalizeLaneSeparators(int laneSize, int laneBorderSize)
        {
