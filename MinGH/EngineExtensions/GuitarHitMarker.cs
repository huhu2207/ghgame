...
{
    public class GuitarHitMarker : HitMarker
    {
        /// <summary>
        ...
        public GuitarHitMarker(int hitMarkerDepth, int hitMarkerSize, int laneSize, int laneBorderSize,  int fretboardBorderSize, Effect effectToUse, Texture2D texture, GraphicsDevice graphics)
        ...
        public override void initalizeHitMarker(int hitMarkerDepth, int hitMarkerSize, int fretboardBorderSize, int laneBorderSize, int laneSize)
        {
            ...
            float right = (5 * laneSize) + (4 * laneBorderSize) + fretboardBorderSize;
