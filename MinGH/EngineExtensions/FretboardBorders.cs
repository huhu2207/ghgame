...
{
    class FretboardBorders : GameObject3D
    {
        /// <summary>
        ...
        public FretboardBorders(int laneSize, int laneBorderSize, Effect effectToUse, Texture2D texture, GraphicsDevice graphics, int fretboardBorderSize)
        ...
        public void initalizeFretboardBorders(int laneSize, int fretboardBorderSize, int laneBorderSize)
        {
